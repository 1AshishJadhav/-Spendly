---
description: Create a spec file and feature brach for the next Spendly step
...
2. `feature-title` - human readable title in Title Case
...
- CLAUDE.md - roadmap, conversation, schema
...
Don not print the full spec in chat unless explicitly asked.
